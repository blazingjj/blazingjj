...
impl LogTabKeybinds {
    ...
    fn extend_from_config(&mut self, config: &LogTabKeybindsConfig) {
        update_keybinds!(
            ...
            LogTabEvent::OpenPullRequest => config.open_pull_request,
    ...
    pub fn bindings(&self) -> Vec<Binding> {
        make_bindings!(
            ...
            LogTabEvent::OpenPullRequest => "open-pull-request", Some(Section::BookmarksAndRemotes), "open a new pull request with the selected bookmark",
